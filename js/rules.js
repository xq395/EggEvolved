...
class Rules {
    ...
    initEvolutionTable() {
        ...
        table["(2,1,0)-(3,2,0)"] = "(3,3,0)"; // 鱼苗吃虬变应龙（融合属性）
        table["(2,1,0)-(2,3,0)"] = "(3,3,0)"; // 鱼苗吃螭变应龙（融合属性）
        ...
        table["(1,2,0)-(3,2,0)"] = "(3,3,0)"; // 幼兽吃虬变应龙（融合属性）
        table["(1,2,0)-(2,3,0)"] = "(3,3,0)"; // 幼兽吃螭变应龙（融合属性）
        ...
        table["(3,2,0)-(1,2,0)"] = "(3,3,0)"; // 虬吃幼兽变应龙（融合属性）
        ...
        // 螭的进化路径
        table["(2,3,0)-(2,1,0)"] = "(3,3,0)"; // 螭吃鱼苗变应龙（融合属性）
